        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-dental-teal transition-colors">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-6">Orari</h3>
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                <Clock className="w-5 h-5 text-dental-aqua mt-0.5" />
                <div>
                  <p className="text-white font-medium mb-2">Orari di Apertura</p>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4 mt-4 md:mt-0">
              <a href="#" className="text-gray-400 hover:text-dental-aqua text-sm">Privacy Policy</a>
              <a href="#" className="text-gray-400 hover:text-dental-aqua text-sm">Cookie Policy</a>
              <a href="#" className="text-gray-400 hover:text-dental-aqua text-sm">Termini e Condizioni</a>
            </div>
          </div>
        </div>
      </div>
