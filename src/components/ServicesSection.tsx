  ...
  return <section id="services" className="py-20 bg-dental-stone/20">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div ref={cardsRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 stagger-animation">
          {services.map((service, index) => <div key={index} className="bg-dental-gray p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border border-dental-stone/30 card-hover">
              <div className="mb-4 w-16 h-16 rounded-full bg-white flex items-center justify-center">
