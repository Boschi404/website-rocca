...
const HeroSection = () => {
  ...
  return <section id="home" ref={sectionRef} className="relative pt-28 md:pt-36 pb-20 md:pb-28 bg-gradient-to-br from-dental-stone/30 via-white to-dental-olive/10 overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-10 relative z-10">
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 stagger-animation">
            <span className="inline-block bg-dental-olive/10 text-dental-olive px-4 py-2 rounded-full text-sm font-medium mb-4 animate-fade-in">
              Studio Odontoiatrico
            </span>
            <h1 className="text-4xl md:text-5xl font-bold mb-4 leading-tight text-neutral-700 lg:text-6xl">
              Dr. Alessio Mario <span className="text-dental-olive">Rocca</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="tel:0362801081" className="flex items-center justify-center space-x-2 bg-dental-olive text-white font-medium py-3 px-6 rounded-md shadow-md hover:shadow-lg hover:bg-opacity-90 transition-all duration-300 transform hover:-translate-y-1">
                <Phone size={20} />
                <span>Chiama ora per informazioni</span>
              </a>
              <button onClick={() => scrollToSection('services')} className="bg-white text-dental-olive font-medium py-3 px-6 rounded-md shadow-md hover:shadow-lg border border-dental-olive transition-all duration-300 transform hover:-translate-y-1">
                Scopri i Servizi
              </button>
            </div>
            <div className="mt-10 flex items-center space-x-6">
              <div className="flex items-center space-x-2">
                <div className="w-10 h-10 rounded-full bg-dental-olive/10 flex items-center justify-center">
                  <span className="text-dental-olive font-bold">5.0</span>
                </div>
                <div>
              ...
              <div className="flex items-center space-x-2">
                <div className="w-10 h-10 rounded-full bg-dental-olive/10 flex items-center justify-center">
                  <span className="text-dental-olive font-bold">15+</span>
                </div>
                <div>
